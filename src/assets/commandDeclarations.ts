...
import { Fish } from "./resourceDeclarations";
import { giveResourceAction } from "../game/commands/actionBuilders";
...
export const FindFishSolo = commands.registerCommand({
    ...
    timeRequired: 0.2,
    finishAction: giveResourceAction(getGame(), 1, "fish"),
...
export const GatherWoodSolo = commands.registerCommand({
    ...
    description:
        "Use your own intuition to venture into the forest and gather wood.",
    timeRequired: 5,
    ...
    visible: (game: Game) => {
        let fishObtained =
            game.Resources.getResourceById("fish").get().amountEverObtained;
...
export const EatFish = commands.registerCommand({
    ...
    nameLong: "Eat Fish",
    description:
        "Eat fish to get a buff to gathering fish and wood for 30 seconds.",
    timeRequired: 3,
    ...
    finishAction: (game, multi) => {},
    visible: (game: Game) => {
        let fishObtained = Fish.amountEverObtained;
